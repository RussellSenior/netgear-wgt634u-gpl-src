...
class Gate
{
	public:
		...
		int GateDeviceSetDefaultConnectionService(struct Upnp_Action_Request *ca_event);
		int GateDeviceGetDefaultConnectionService(struct Upnp_Action_Request *ca_event);
